...
base_command="python train_test_model_efsinglepass.py -trf ../data/mhc1_el_subsample/mhc1_el_1M_structure.csv -tef ../data/test_sets_ligands_abelin_wo_context/merged_test_sets_ligands_abelin_no_U.csv -ml 13 -ws 9 -pad -20 -y target -x sequence -std False -bn False -nh 54 -br 15 -otf True -cuda True -bs 1024 -ne 500 -wd 0 -add_ps True -indel True --add_pfr True --add_fr_len True --add_pep_len True --add_structure False -lr 1e-5"
...
# Base command without the parameters that will change
base_command="python train_test_model_efsinglepass.py -trf ../data/mhc1_el_subsample/mhc1_el_1M_structure.csv -tef ../data/test_sets_ligands_abelin_wo_context/merged_test_sets_ligands_abelin_no_U.csv -ml 13 -ws 9 -pad -20 -y target -x sequence -std False -bn False -nh 54 -br 10 -otf True -cuda True -bs 1024 -ne 500 -wd 0 -add_ps True -indel True --add_pfr True --add_fr_len True --add_pep_len True --add_structure False -lr 1e-5 -bn True -do 0.25 -add_hl True -nh2 27"
