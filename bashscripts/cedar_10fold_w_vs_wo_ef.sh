...
for f in $(seq 0 9);
do
  python3 ./train_model_ef.py -f ../data/aligned_icore/230530_cedar_aligned.csv -kf ${f} -o 230530_CEDAR_WITH_EF -enc BL50LO -x mutant -y target -fc EL_rank_mut icore_selfsimilarity -ml 12 -pad -15 -nh 25 -std True -bn True -do 0.15 -ws 5 -efnh 5 -efbn True -efdo 0.15 -lr 1e-4 -bs 128 -ne 300 -tol 0.0001 &
  pids+=($!)
done
