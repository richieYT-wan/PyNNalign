...
# Script 2
SCRIPT2="./benchmark_python_sequential.sh"
...
run_script "$SCRIPT2" > /home/projects/vaccine/people/yatwan/PyNNalign/output/time_benchmark/python_benchmark_qsub_sequential.txt
