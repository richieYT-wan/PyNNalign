...
do
  ...
  python3 python3 train_model.py -f ../data/NetMHCIIpan_train/drb1_0301.csv -kf ${f} -enc BL50LO -ml 21 -pad -15 -nh 500 -std True -bn True -do 0.0 -ws 9 -lr 1e-4 -bs 256 -ne 25 -tol 0.0001" > "230524_DRB1_kcv_f${f}.sh"
