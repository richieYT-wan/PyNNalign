...
from src.data_processing import DATADIR, OUTDIR
import argparse
...
def args_parser():
    ...
    """
    parser.add_argument('-el', '--extra_layer', dest='extra_layer', required=True,
                        type = str, help ='single or double, amount of layers in Extra layer')
...
def main():
    ...
    model_keys = ['n_hidden', 'window_size', 'batchnorm', 'dropout', 'standardize', 'extra_layer', 'n_hidden_ef', 'batchnorm_ef', 'dropout_ef']
